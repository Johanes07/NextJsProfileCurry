        ...
        <section className="py-24 bg-zinc-950">
            <div className="max-w-7xl mx-auto px-6">
                <div className="grid md:grid-cols-2 gap-16 items-center">
                    ...
                    {/* Right - Content */}
                    <div>
                        <span className="inline-block bg-yellow-400/10 text-yellow-400 text-sm font-bold px-4 py-2 rounded-full mb-6 border border-yellow-400/20">How It All Started</span>
                        <h2 className="text-4xl md:text-5xl font-black text-white mb-6 leading-tight">
                            FROM A HOME
                            <span className="block text-yellow-400">KITCHEN TO</span>
                            THE WORLD
                        </h2>
                        ...
                        <div className="mt-10 grid grid-cols-3 gap-4">
                            {[
                                ...
                                { value: '50K+', label: 'Bowls Served' },
                            ].map(({ value, label }) => (
                                <div key={label} className="border border-yellow-400/20 rounded-2xl p-4 text-center bg-yellow-400/5">
