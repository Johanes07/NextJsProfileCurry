        ...
        <section className="relative min-h-[60vh] overflow-hidden bg-black flex items-center">
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-6 pt-32 pb-20 w-full">
                ...
                <div className="mb-6 space-y-3">
                    <div className="h-16 md:h-24 w-64 bg-white/10 rounded-xl animate-pulse" />
                    <div className="h-16 md:h-24 w-32 bg-yellow-400/20 rounded-xl animate-pulse" />
                </div>
...
export function CareerHero() {
    ...
    const [data, setData] = useState<CareerHeroData | null>(null)
    ...
    useEffect(() => {
        fetch('/api/admin/career/hero', { cache: 'no-store' })
            .then(r => r.json())
            .then((d: Partial<CareerHeroData> & { updatedAt?: string }) => {
        ...
        return (
            <section className="relative min-h-[60vh] overflow-hidden bg-black flex items-center">
                <div className="absolute inset-0">
                    ...
                    <Image src={data.imageUrl} alt="Career Hero" fill
                        className={`object-cover transition-opacity duration-700 ${imgReady ? 'opacity-70' : 'opacity-0'}`}
                        priority unoptimized onLoad={() => setImgReady(true)} />
                ...
                <div className="relative z-10 max-w-7xl mx-auto px-6 pt-32 pb-20 w-full">
                    ...
                    <div className={fadeUp(v[3], 'mb-10')}>
                        <p className="text-white/50 text-xl max-w-xl leading-relaxed">{data.subtitle}</p>
                    </div>
                </div>
            </section>
        )
    ...
    return (
        <section className="relative min-h-[60vh] overflow-hidden bg-amber-50 flex items-center">
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-6 pt-32 pb-20 w-full">
                ...
                <div className={fadeUp(v[3], 'mb-10')}>
                    <p className="text-gray-500 text-xl max-w-xl leading-relaxed">{data.subtitle}</p>
                </div>
            </div>
        </section>
    )
