...
export function MenuHero() {
    ...
    const [content, setContent] = useState<MenuHeroData>(DEFAULT)
        ...
        return (
            <section className="relative min-h-[60vh] overflow-hidden bg-black flex items-center">
                <div className="absolute inset-0">
                    <Image src={img!} alt="Menu Hero" fill className="object-cover opacity-50" priority />
    ...
    return (
        <section className="relative min-h-[60vh] overflow-hidden bg-amber-50 flex items-center">
            ...
            <div className="absolute right-0 top-0 bottom-0 w-1/2 hidden md:block">
                <Image src={img!} alt="Menu Hero" fill className="object-cover object-center opacity-100" priority />
