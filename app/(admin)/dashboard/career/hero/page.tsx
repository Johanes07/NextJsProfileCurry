...
function LivePreview({ data, isDark }: { data: CareerHeroData; isDark: boolean }) {
    if (isDark) {
        return (
            <section className="relative min-h-[280px] overflow-hidden bg-black flex items-center">
    ...
    return (
        <section className="relative min-h-[280px] overflow-hidden bg-amber-50 flex items-center">
    ...
    return (
        <div className="p-8 bg-black min-h-screen">
            ...
            <div className="flex items-center justify-between mb-8">
                <div>
                    <h1 className="text-3xl font-black text-white">Career Hero</h1>
                    <p className="text-white/40 text-sm mt-1">Edit konten section hero halaman career</p>
                </div>
                ...
                <div className="space-y-4">
                    ...
                    <div className="bg-white/[0.03] border border-white/5 rounded-2xl p-6">
                        ...
                        <Field label="TEKS BADGE" value={data.badgeText} onChange={set('badgeText')}
                            placeholder="JOIN THE TEAM" mono hint="Gunakan HURUF KAPITAL" />
                    </div>
                    ...
                    <div className="bg-white/[0.03] border border-white/5 rounded-2xl p-6">
                        ...
                        <div className="grid grid-cols-2 gap-4 mb-4">
                            <Field label="BARIS PERTAMA" value={data.headingLine1} onChange={set('headingLine1')}
                                placeholder="WORK WITH" mono hint="Warna putih" />
                            <Field label="BARIS KEDUA" value={data.headingLine2} onChange={set('headingLine2')}
                                placeholder="US" mono hint="Warna kuning / aksen" />
                        </div>
                    ...
                    <div className="bg-white/[0.03] border border-white/5 rounded-2xl p-6">
                        ...
                        <Field label="TEKS SUBTITLE" value={data.subtitle} onChange={set('subtitle')}
                            placeholder="Be part of something obsessive..." textarea
                        ...
                        <div className="rounded-2xl overflow-hidden border border-white/10">
                            <div className="bg-white/5 border-b border-white/5 px-4 py-2.5 flex items-center gap-2">
                                ...
                                <span className="text-xs text-white/20 ml-2 font-mono">
                                    /career — {previewDark ? '🌙 dark' : '☀️ light'}
                                </span>
                            </div>
