...
export default function ContactHeroCMS() {
    ...
    const set = (key: keyof ContactHeroData) => (val: string) => setData(prev => ({ ...prev, [key]: val }))
    ...
    return (
        <div className="p-8 bg-black min-h-screen">
            ...
            <div className="flex items-center justify-between mb-8">
                <div>
                    <h1 className="text-3xl font-black text-white">Contact Hero</h1>
                    <p className="text-white/40 text-sm mt-1">Edit konten section hero halaman contact</p>
                </div>
                ...
                <div className="space-y-4">
                    ...
                    <div className="bg-white/[0.03] border border-white/5 rounded-2xl p-6">
                        ...
                        <Field label="TEKS BADGE" value={data.badgeText} onChange={set('badgeText')}
                            placeholder="FIND US" mono hint="Gunakan HURUF KAPITAL" />
                    </div>
                    ...
                    <div className="bg-white/[0.03] border border-white/5 rounded-2xl p-6">
                        ...
                        <div className="grid grid-cols-2 gap-4 mb-4">
                            <Field label="BARIS PERTAMA" value={data.headingLine1} onChange={set('headingLine1')}
                                placeholder="GET IN" mono hint="Warna putih" />
                            <Field label="BARIS KEDUA" value={data.headingLine2} onChange={set('headingLine2')}
                                placeholder="TOUCH" mono hint="Warna kuning / aksen" />
                        </div>
                    ...
                    <div className="bg-white/[0.03] border border-white/5 rounded-2xl p-6">
                        ...
                        <Field label="TEKS SUBTITLE" value={data.subtitle} onChange={set('subtitle')}
                            placeholder="Have a question? Want to reserve a table?..." textarea
